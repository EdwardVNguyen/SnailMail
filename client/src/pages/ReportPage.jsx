        ...
        >
          {loadingDetails ? (
            ...
            <div className="facilityDetailsContent">
              ...
              <DetailSection sectionKey="packagesReceived" title="Packages Received" description="All packages that arrived at this facility during the selected date range" data={facilityDetails.details.packagesReceived} extraColumn={[{ field: 'received_date', label: 'Received Date' }, { field: 'courier_name', label: 'Courier' }]} defaultSortField="received_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="clerkCreatedEvents" title="Clerk Created Events" description="Tracking events created by clerks at this facility" data={facilityDetails.details.clerkCreatedEvents} extraColumn={[{ field: 'event_time', label: 'Event Time' }, { field: 'clerk_name', label: 'Clerk' }]} defaultSortField="event_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="packagesDelivered" title="Packages Delivered" description="Packages delivered to their final destination from this facility" data={facilityDetails.details.packagesDelivered} extraColumn={[{ field: 'delivery_date', label: 'Delivery Date' }, { field: 'delivered_by', label: 'Delivered By' }]} defaultSortField="delivery_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="packagesLost" title="Problem Packages" description="Packages with issues such as lost, damaged, undeliverable, or failed delivery" data={facilityDetails.details.packagesLost} extraColumn={[{ field: 'lost_date', label: 'Lost Date' }, { field: 'marked_by', label: 'Marked by Clerk' }, { field: 'last_courier', label: 'Last Courier' }]} defaultSortField="lost_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="packagesSent" title="Packages Sent" description="Packages transferred to other facilities" data={facilityDetails.details.packagesSent} extraColumn={[{ field: 'sent_time', label: 'Sent Date' }, { field: 'destination_facility', label: 'Destination Facility' }]} defaultSortField="sent_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="statusInTransit" title="In Transit" description="Packages currently being held by couriers" data={facilityDetails.details.statusInTransit} extraColumn={[{ field: 'status_date', label: 'Transit Date' }, { field: 'courier_name', label: 'Courier' }]} defaultSortField="status_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="statusOutForDelivery" title="Out for Delivery" description="Packages currently out for delivery to recipients" data={facilityDetails.details.statusOutForDelivery} extraColumn={[{ field: 'status_date', label: 'Out for Delivery Date' }, { field: 'courier_name', label: 'Courier' }]} defaultSortField="status_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
            </div>
          ) : (
        ...
        >
          {loadingClerkDetails ? (
            ...
            <div className="facilityDetailsContent">
              ...
              <DetailSection sectionKey="reviewsApproved" title="Reviews Approved" description="Courier package requests approved by this clerk" data={clerkDetails.details.reviewsApproved} extraColumn={[{ field: 'review_date', label: 'Review Date' }, { field: 'courier_name', label: 'Courier' }]} defaultSortField="review_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="reviewsRejected" title="Reviews Rejected" description="Courier package requests rejected by this clerk" data={clerkDetails.details.reviewsRejected} extraColumn={[{ field: 'review_date', label: 'Review Date' }, { field: 'courier_name', label: 'Courier' }]} defaultSortField="review_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="trackingEvents" title="Tracking Events Created" description="All tracking events created by this clerk" data={clerkDetails.details.trackingEvents} extraColumn={{ field: 'event_time', label: 'Event Time' }} defaultSortField="event_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="problemPackages" title="Problem Packages" description="Packages marked as lost, undeliverable, failed-delivery, or damaged by this clerk" data={clerkDetails.details.problemPackages} extraColumn={{ field: 'event_time', label: 'Event Time' }} defaultSortField="event_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="packagesProcessed" title="Packages Processed" description="Unique packages this clerk created tracking events for" data={clerkDetails.details.packagesProcessed} extraColumn={{ field: 'first_processed', label: 'First Processed' }} defaultSortField="first_processed" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
            </div>
          ) : (
            <div>No details available</div>
          )}
        ...
        >
          {loadingCourierDetails ? (
            ...
            <div className="facilityDetailsContent">
              ...
              <DetailSection sectionKey="packagesClaimed" title="Packages Claimed" description="Approved package requests claimed by this courier" data={courierDetails.details.packagesClaimed} extraColumn={[{ field: 'review_date', label: 'Approved Date' }, { field: 'reviewed_by_name', label: 'Approved By' }]} defaultSortField="review_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="finalDeliveries" title="Final Deliveries" description="Packages delivered to recipients" data={courierDetails.details.finalDeliveries} extraColumn={{ field: 'delivery_time', label: 'Delivery Time' }} defaultSortField="delivery_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="packagesLost" title="Packages Lost" description="Problem packages where this courier was last to handle" data={courierDetails.details.packagesLost} extraColumn={{ field: 'lost_date', label: 'Lost Date' }} defaultSortField="lost_date" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="facilityTransfers" title="Facility Transfers" description="Packages delivered to facilities" data={courierDetails.details.facilityTransfers} extraColumn={[{ field: 'delivery_time', label: 'Delivery Time' }, { field: 'destination_facility', label: 'Destination' }]} defaultSortField="delivery_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="packagesInTransit" title="Currently Holding" description="Packages currently in transit with this courier" data={courierDetails.details.packagesInTransit} extraColumn={{ field: 'last_updated', label: 'Last Updated' }} defaultSortField="last_updated" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
              <DetailSection sectionKey="allTrackingEvents" title="All Tracking Events" description="All tracking events created by this courier" data={courierDetails.details.allTrackingEvents} extraColumn={{ field: 'event_time', label: 'Event Time' }} defaultSortField="event_time" defaultSortDirection="desc" collapsedSections={collapsedSections} detailPages={detailPages} detailSortField={detailSortField} detailSortDirection={detailSortDirection} onSectionToggle={handleSectionToggle} onDetailSort={handleDetailSort} onPageChange={handlePageChange} />
            </div>
          ) : (
            <div>No details available</div>
          )}
